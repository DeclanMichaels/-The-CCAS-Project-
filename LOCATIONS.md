...
Canonical index of every public location for **The CCAS Project — Cross-Cultural Alignment Study (program umbrella)**.
Each home below should link back to this file, so any entry point reaches the whole set.

## Locations

- **Source (data + code)** — GitHub: https://github.com/DeclanMichaels/the-ccas-project  ← living source
- **Archived snapshot (citable)** — Zenodo: `TBD` (mint the DOI, then update this file and `CITATION.cff`)
- **Preprint / report** — https://moral-os.com  (program home)
